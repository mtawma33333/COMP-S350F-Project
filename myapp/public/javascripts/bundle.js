...
var login = exports.login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(uid, password) {
    var res;
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateSetting.js":[function(require,module,exports) {
"use strict";
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'http://localhost:3000/api/user/updateMyPassword' : 'http://localhost:3000/api/user/updateMe';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateData.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateData = exports.DeleteOne = exports.CreateOne = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var updateData = exports.updateData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type, option) {
    var path, id, url, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          id = path.split('/')[2]; // assuming the path is "/user/:id/update"
          url = "http://localhost:3000/api/".concat(option, "/").concat(id);
          console.log(data);
          _context.next = 7;
          return (0, _axios.default)({
            method: 'PATCH',
...
var CreateOne = exports.CreateOne = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(data, type, option) {
    var url, res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          url = type === 'user' ? 'http://localhost:3000/api/user/signup' : "http://localhost:3000/api/".concat(option, "/");
          console.log(data);
          _context2.next = 5;
          return (0, _axios.default)({
            method: 'POST',
        ...
        case 5:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " Create successfully!"));
          }
          _context2.next = 12;
          break;
        case 9:
  ...
  return function CreateOne(_x4, _x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();
...
var UpdateUserForm = document.querySelector('.form-update-user');
var UpdateCourseForm = document.querySelector('.form-update-course');
var UpdateRecordForm = document.querySelector('.form-update-record');
var CreateUserForm = document.querySelector('.form-create-user');
var CreateCourseForm = document.querySelector('.form-create-course');
var CreateRecordForm = document.querySelector('.form-create-record');
var deleteCourseBtns = document.querySelectorAll('.delete-course-btn');
deleteCourseBtns.forEach(function (btn) {
  btn.addEventListener('click', function (event) {
    return (0, _updateData.DeleteOne)('course', event.target.id);
  });
});
var deleteReocrdBtns = document.querySelectorAll('.delete-record-btn');
deleteReocrdBtns.forEach(function (btn) {
  btn.addEventListener('click', function (event) {
    return (0, _updateData.DeleteOne)('record', event.target.id);
  });
});
var deleteUserBtns = document.querySelectorAll('.delete-user-btn');
deleteUserBtns.forEach(function (btn) {
  btn.addEventListener('click', function (event) {
    return (0, _updateData.DeleteOne)('user', event.target.id);
  });
});
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  var brith = new Date(document.getElementById('brith').value);
...
if (UpdateCourseForm) UpdateCourseForm.addEventListener('submit', function (e) {
  e.preventDefault();
...
if (UpdateRecordForm) UpdateRecordForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var mark = document.getElementById('mark').value;
  var status = document.getElementById('status').value;
  var year = document.getElementById('year').value;
  var comments = new Date(document.getElementById('comments').value);
  (0, _updateData.updateData)({
    mark: mark,
    status: status,
    year: year,
...
if (CreateRecordForm) CreateRecordForm.addEventListener('submit', function (e) {
  e.preventDefault();
...
},{"./login":"login.js","./updateSetting":"updateSetting.js","./updateData":"updateData.js","./alerts":"alerts.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
